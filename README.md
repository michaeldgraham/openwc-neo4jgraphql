...
### [`/web-openwc`](./web-openwc)

An [Open-WC](https://open-wc.org/) SPA using Web Components with [LitElement](https://lit-element.polymer-project.org/), using TypeScript, [decorators](https://lit-element.polymer-project.org/guide/decorators), [Apollo Client 3.0](https://www.npmjs.com/package/@apollo/client), and a live reload server using [es-dev-server](https://open-wc.org/developing/es-dev-server.html).

_Build typescript, rollup apollo, and start es-dev-server_

```
cd ./web-openwc && npm run build && npm run start
```

See [the project releases](https://github.com/grand-stack/grand-stack-starter/releases) for the changelog.

TODO: Deployment not yet implemented for web-openwc
